...
%>
	...
	<ul>
		...
		<li><a class="active" href="http://localhost:8088/newProject01/mgrMyInfoServlet">View My Info</a></li>
	...
	<div id="fancy">
		<div id="content">
			<table>
				...
				<c:url var="tempLink" value="http://localhost:8088/newProject01/mgrMyInfoServlet">
