...
/**
 * Servlet implementation class ReimbMgrViewPendServlet
 */
@WebServlet("/ReimbMgrViewPendServlet")
public class ReimbMgrViewPendServlet extends HttpServlet {
	 ...
	 */
	public ReimbMgrViewPendServlet() {
		super();
	...
	private void updateRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// call the DBUtil and give it the value to update using the requestID
		try {
			// update Database
			reimbursementDbUtil.approveDeny(request, response);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("approve/deny updateRequest threw exception!");
			e.printStackTrace();
		}
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/manager/list-mpending.jsp");
