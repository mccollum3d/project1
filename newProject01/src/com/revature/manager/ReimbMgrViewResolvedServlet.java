...
/**
 * Servlet implementation class ReimbMgrViewResolvedServlet
 */
@WebServlet("/ReimbMgrViewResolvedServlet")
public class ReimbMgrViewResolvedServlet extends HttpServlet {
     ...
     */
    public ReimbMgrViewResolvedServlet() {
        super();
	...
	private void listPending(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/manager/list-mresolved.jsp");
